...
from tsase.neb.util import vmag, vunit, vproj, vdot, sPBC
...
class ssneb:
    ...
    def __init__(self, p1, p2, numImages = 7, k = 5.0, tangent = "new",  nebimages=None,      \
